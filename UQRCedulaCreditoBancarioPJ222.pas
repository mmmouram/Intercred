...
unit UQRCedulaCreditoBancarioPJ222;
...
type
  TQRCedulaCreditoBancarioPJ222 = class(TQuickRep)
    QRBand1: TQRBand;
    QRShape2: TQRShape;
...
var
  QRCedulaCreditoBancarioPJ222: TQRCedulaCreditoBancarioPJ222;
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBTextValor3Print(sender: TObject; var Value: String);
begin
 if (ADOContratoCedulaValor3.AsFloat = 0) Then
    value := '';
end;

procedure TQRCedulaCreditoBancarioPJ222.QRLabel62Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel63Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel64Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel65Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel66Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel67Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel68Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel69Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel70Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel71Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel72Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel73Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel74Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel75Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel76Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel77Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel83Print(sender: TObject;
  var Value: String);
begin
  if (ADOSegundoAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel88Print(sender: TObject;
  var Value: String);
begin
  if (ADOPrimeiroAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel90Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel92Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel94Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel84Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel85Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel86Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBTextValor1Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBTextValor2Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText18Print(sender: TObject;
  var Value: String);
begin
  if (ADOPrimeiroAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText16Print(sender: TObject;
  var Value: String);
begin
  if (ADOPrimeiroAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText17Print(sender: TObject;
  var Value: String);
begin
  if (ADOPrimeiroAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRSysData1Print(sender: TObject;
  var Value: String);
begin
  Value := Format('%2.2d',[StrToInt64(Value)]);
end;

procedure TQRCedulaCreditoBancarioPJ222.QuickRepBeforePrint(
...
procedure TQRCedulaCreditoBancarioPJ222.QuickRepStartPage(Sender: TCustomQuickRep);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBTextVenc1Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBTextVenc2Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRBand2BeforePrint(Sender: TQRCustomBand;
...
procedure TQRCedulaCreditoBancarioPJ222.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   cont:=cont+1;
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText14Print(sender: TObject;
  var Value: String);
begin
    Value := FormataCPFCNPJ(ADOSegundoAvalistaInscricaoAvalista.AsString);
end;

procedure TQRCedulaCreditoBancarioPJ222.QRDBTextVenc3Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText29Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText26Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRDBText3Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel44Print(sender: TObject;
  var Value: String);
begin
    if (ADOSegundoAvalista.Active) then
    Value := ADOSegundoAvalistaEstadoCivil.AsString
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel53Print(sender: TObject;
  var Value: String);
begin
    if (ADOPrimeiroAvalista.Active) then
    Value := ADOPrimeiroAvalistaEstadoCivil.AsString
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel54Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel60Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel157Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel159Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel170Print(sender: TObject;
  var Value: String);
begin
  if (ADOTerceiroAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel164Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel173Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel160Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel171Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel161Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel187Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel172Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel162Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel165Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel182Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel183Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel194Print(sender: TObject;
  var Value: String);
begin
  if (ADOQuartoAvalista.Active) then
  begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel188Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel184Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel195Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel185Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel163Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel196Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel186Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel189Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel210Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel209Print(sender: TObject;
  var Value: String);
begin
    if (ADOTerceiroAvalista.Active) then
    Value := ADOTerceiroAvalistaEstadoCivil.AsString
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel211Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel208Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
    Value := ADOQuartoAvalistaEstadoCivil.AsString
...
procedure TQRCedulaCreditoBancarioPJ222.QRLabel197Print(sender: TObject;
  var Value: String);
begin
    if (ADOQuartoAvalista.Active) then
...
procedure TQRCedulaCreditoBancarioPJ222.ChildBand2AfterPrint(
...
procedure TQRCedulaCreditoBancarioPJ222.Contrato;
begin
...
constructor TQRCedulaCreditoBancarioPJ222.Create(AOwner : TComponent; Origem: Integer = 0);
begin
  CreateNew(AOwner);
