...
describe("EmprestimoForm", () => {
  it("renders all required fields", () => {
    renderWithProviders(<EmprestimoForm />);
  ...
  it("calls onSuccess after successful submit", async () => {
    ...
    jest.spyOn(require("@hooks/useEmprestimo"), "useCreateEmprestimo").mockReturnValue({
      mutate: mutateMock,
      isPending: false,
      isError: false,
      isSuccess: false,
    ...
    renderWithProviders(<EmprestimoForm onSuccess={onSuccess} />);
